...
class Factory
{
    ...
    {
        return new \YoastSEO_Vendor\Lcobucci\JWT\Claim\GreaterOrEqualsTo($name, $value);
    }
    /**
     * Creates a claim that can be compared (greator or equals)
     *
    ...
    {
        return new \YoastSEO_Vendor\Lcobucci\JWT\Claim\LesserOrEqualsTo($name, $value);
    }
    /**
    ...
    {
        return new \YoastSEO_Vendor\Lcobucci\JWT\Claim\EqualsTo($name, $value);
    }
    /**
    ...
    {
        return new \YoastSEO_Vendor\Lcobucci\JWT\Claim\Basic($name, $value);
    }
}

    ...
    public function jsonDecode($json)
    {
        if (\PHP_VERSION_ID < 70300) {
            ...
            if (\json_last_error() != \JSON_ERROR_NONE) {
                throw \YoastSEO_Vendor\Lcobucci\JWT\Encoding\CannotDecodeContent::jsonIssues(new \JsonException(\json_last_error_msg()));
            }
            return $data;
        }
        try {
            ...
            throw \YoastSEO_Vendor\Lcobucci\JWT\Encoding\CannotDecodeContent::jsonIssues($exception);
        }
    }
    /**

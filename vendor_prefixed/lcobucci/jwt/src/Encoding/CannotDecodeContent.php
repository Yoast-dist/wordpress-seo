...
namespace YoastSEO_Vendor\Lcobucci\JWT\Encoding;

use JsonException;
use YoastSEO_Vendor\Lcobucci\JWT\Exception;
use RuntimeException;
final class CannotDecodeContent extends \RuntimeException implements \YoastSEO_Vendor\Lcobucci\JWT\Exception
{
    /**

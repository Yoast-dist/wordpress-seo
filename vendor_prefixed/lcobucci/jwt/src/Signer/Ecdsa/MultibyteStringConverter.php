 ...
 * @internal
 */
final class MultibyteStringConverter implements \YoastSEO_Vendor\Lcobucci\JWT\Signer\Ecdsa\SignatureConverter
{
    ...
    public function toAsn1($signature, $length)
    {
        ...
        if (self::octetLength($signature) !== $length) {
            throw \YoastSEO_Vendor\Lcobucci\JWT\Signer\Ecdsa\ConversionFailed::invalidLength();
        }
    ...
    public function fromAsn1($signature, $length)
    {
        ...
        if (self::readAsn1Content($message, $position, self::BYTE_SIZE) !== self::ASN1_SEQUENCE) {
            throw \YoastSEO_Vendor\Lcobucci\JWT\Signer\Ecdsa\ConversionFailed::incorrectStartSequence();
        }
    ...
    private static function readAsn1Integer($message, &$position)
    {
        if (self::readAsn1Content($message, $position, self::BYTE_SIZE) !== self::ASN1_INTEGER) {
            throw \YoastSEO_Vendor\Lcobucci\JWT\Signer\Ecdsa\ConversionFailed::integerExpected();
        }

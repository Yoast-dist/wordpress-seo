 ...
 */
namespace YoastSEO_Vendor\League\OAuth2\Server\RequestTypes;
...
class AuthorizationRequest
{
     ...
     */
    public function setClient(\YoastSEO_Vendor\League\OAuth2\Server\Entities\ClientEntityInterface $client)
    {
        $this->client = $client;
    }
    /**
     ...
     */
    public function setUser(\YoastSEO_Vendor\League\OAuth2\Server\Entities\UserEntityInterface $user)
    {
        $this->user = $user;
    }
    /**

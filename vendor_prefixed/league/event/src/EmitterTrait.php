...
trait EmitterTrait
{
     ...
     * @return $this
     */
    public function addListener($event, $listener, $priority = \YoastSEO_Vendor\League\Event\ListenerAcceptorInterface::P_NORMAL)
    {
     ...
     * @return $this
     */
    public function addOneTimeListener($event, $listener, $priority = \YoastSEO_Vendor\League\Event\ListenerAcceptorInterface::P_NORMAL)
    {

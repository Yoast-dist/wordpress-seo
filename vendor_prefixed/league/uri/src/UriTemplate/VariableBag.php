...
final class VariableBag
{
    ...
    private function normalizeValue($value, string $name, bool $isNestedListAllowed)
    {
        ...
        if (!$isNestedListAllowed) {
            throw \YoastSEO_Vendor\League\Uri\Exceptions\TemplateCanNotBeExpanded::dueToNestedListOfValue($name);
        }
     ...
     */
    public function replace(\YoastSEO_Vendor\League\Uri\UriTemplate\VariableBag $variables) : self
    {
        $instance = clone $this;

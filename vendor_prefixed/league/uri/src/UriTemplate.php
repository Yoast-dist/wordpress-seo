...
use YoastSEO_Vendor\League\Uri\UriTemplate\Template;
use YoastSEO_Vendor\League\Uri\UriTemplate\VariableBag;
/**
...
final class UriTemplate
{
    ...
    {
        $this->template = \YoastSEO_Vendor\League\Uri\UriTemplate\Template::createFromString($template);
     ...
     */
    private function filterVariables(array $variables) : \YoastSEO_Vendor\League\Uri\UriTemplate\VariableBag
    {
        $output = new \YoastSEO_Vendor\League\Uri\UriTemplate\VariableBag();
     ...
     */
    public function expand(array $variables = []) : \YoastSEO_Vendor\League\Uri\Contracts\UriInterface
    {
        $uriString = $this->template->expand($this->filterVariables($variables)->replace($this->defaultVariables));
        return \YoastSEO_Vendor\League\Uri\Uri::createFromString($uriString);
    }
}

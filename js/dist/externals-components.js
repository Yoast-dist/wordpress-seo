...
(0,s.__)("(Opens in a new browser tab)","wordpress-seo")))))}}K.propTypes={keyphrase:l().string,location:l().string,whichModalOpen:l().oneOf(["none","metabox","sidebar"]),isLoggedIn:l().bool,onOpen:l().func.isRequired,onOpenWithNoKeyphrase:l().func.isRequired,onClose:l().func.isRequired,onAuthentication:l().func.isRequired,shouldCloseOnClickOutside:l().bool},K.defaultProps={keyphrase:"",location:"",whichModalOpen:"none",isLoggedIn:!1,shouldCloseOnClickOutside:!0};const U=K,q=(0,k.compose)([(0,_.withSelect)((e=>{const{getSEMrushModalOpen:t,getSEMrushLoginStatus:s,getIsElementorEditor:o}=e("yoast-seo/editor");return{whichModalOpen:t(),isLoggedIn:s(),shouldCloseOnClickOutside:!o()}})),(0,_.withDispatch)((e=>{const{setSEMrushNoKeyphraseMessage:t,setSEMrushOpenModal:s,setSEMrushDismissModal:o,setSEMrushLoginStatus:r}=e("yoast-seo/editor");return{onOpenWithNoKeyphrase:()=>{t()},onOpen:e=>{s(e)},onClose:()=>{o()},onAuthentication:e=>{r(e)}}}))])(U),H=window.yoast.styleGuide,z=(0,n.makeOutboundLink)(d().a`
	...
	color: ${H.colors.$color_help_text};
	
	&:hover,
	&:focus {
		color: ${H.colors.$color_snippet_focus};	
	}
...
`),D=H.colors.$color_bad,W=H.colors.$palette_error_background,Y=H.colors.$color_grey_text_light,j=H.colors.$palette_error_text,G=d().div`
	display: flex;
...
`,J=d()(r.InputField)`
	...
	&.has-error {
		...
		&:focus {
			box-shadow: 0 0 2px ${D} !important;
		}
	}
`,X=d().ul`
	color: ${j};
...
`,ee=(0,r.addFocusStyle)(d().button`
		...
		padding: 0;
		cursor: pointer;
	`);ee.propTypes={type:l().string,focusColor:l().string,focusBackgroundColor:l().string,focusBorderColor:l().string},ee.defaultProps={type:"button",focusColor:H.colors.$color_button_text_hover,focusBackgroundColor:"transparent",focusBorderColor:H.colors.$color_blue};const te=d()(r.SvgIcon)`
	margin-top: 4px;
`,se=d().div`
	display: flex;
	flex-direction: row;
...
(0,s.__)("%1$s24/7 support%2$s: Also on evenings and weekends.","wordpress-seo"),"<strong>","</strong>")],xe=d().div`
...
`,Ge=d().div`
	...
	${(0,n.getDirectionalStyle)("border-left","border-right")}: 4px solid ${H.colors.$color_pink_dark};
	margin: 16px 0;
	padding: 0 0 0 8px;
	max-width: 600px;
...
`,Qe=(0,n.makeOutboundLink)(r.UpsellLinkButton),Je=e=>{const{alignment:o,url:r}=e;return(0,t.createElement)(Ge,{alignment:o},(0,t.createElement)(je,null,(0,s.sprintf)(/* translators: %s expands to Yoast SEO Premium */

...
`,Pt=c.a.a`
	font-weight: bold;
`,It=Object(u.makeOutboundLink)(Pt),zt=c.a.div`
	text-align: center;
`,Mt=c.a.div`
	ul {
...
`,Lt=c.a.div`
	...
	flex-grow: 1;
`;class Dt extends a.a.Component{getActionBlock(e,t){const o=Object(u.makeOutboundLink)(e);return"true"===t?Object(r.createElement)(zt,null,Object(r.createElement)(o,{href:this.props.courseUrl},this.props.ctaButtonData.ctaButtonCopy)):Object(r.createElement)(zt,null,Object(r.createElement)(o,{href:this.props.ctaButtonData.ctaButtonUrl},this.props.ctaButtonData.ctaButtonCopy),Object(r.createElement)(It,{href:this.props.courseUrl},this.props.readMoreLinkText))}render(){const e="regular"===this.props.ctaButtonData.ctaButtonType?Rt:Bt;return Object(r.createElement)(n.Fragment,null,Object(r.createElement)(Lt,null,Object(r.createElement)(Mt,{dangerouslySetInnerHTML:{__html:this.props.description}})),this.getActionBlock(e,this.props.isBundle))}}var At=Dt;Dt.propTypes={description:l.a.string,courseUrl:l.a.string,ctaButtonData:l.a.object,readMoreLinkText:l.a.string,isBundle:l.a.string},Dt.defaultProps={description:"",courseUrl:"",ctaButtonData:{},readMoreLinkText:"",isBundle:""};var Ft=o(36),Ut=o.n(Ft);const Ht=j()([T,k,S])(c.a.button`
		display: inline-flex;
		flex-direction: column;
		justify-content: center;
		align-items: center;
...
`;class Qt extends n.PureComponent{render(){const{children:e,textColor:t,textFontSize:o}=this.props;return Object(r.createElement)(Jt,{textColor:t,textFontSize:o},e)}}const eo={children:l.a.oneOfType([l.a.string,l.a.array]),textColor:l.a.string,textFontSize:l.a.string};Qt.propTypes={...eo,children:eo.children.isRequired},Qt.defaultProps={textColor:d.colors.$color_help_text};const to=e=>{const t=c()(e.icon)`
		...
		flex: 0 0 auto;
	`,o=Ut()(e,["icon","width","height","color"]);return Object(r.createElement)(t,P()({role:"img","aria-hidden":"true",focusable:"false"},o))};to.propTypes={icon:l.a.func.isRequired,width:l.a.string,height:l.a.string,color:l.a.string},to.defaultProps={width:"16px",height:"16px"};var oo=to;const ro=c.a.button`
	box-sizing: border-box;
	min-width: 32px;
	display: inline-block;
...
`,io=function(e){return Object(r.createElement)(lo,{type:"button",onClick:e.onClick,boxShadowColor:e.boxShadowColor,background:e.background,id:e.id,"aria-label":e.ariaLabel,iconColor:e.iconColor,hoverBorderColor:e.hoverBorderColor,className:e.className},Object(r.createElement)(y,{icon:e.icon,color:e.iconColor,size:"18px"}))};io.propTypes={id:l.a.string.isRequired,ariaLabel:l.a.string.isRequired,onClick:l.a.func.isRequired,boxShadowColor:l.a.string,background:l.a.string,iconColor:l.a.string,icon:l.a.string.isRequired,hoverBorderColor:l.a.string,className:l.a.string},io.defaultProps={boxShadowColor:d.colors.$color_button_border,background:d.colors.$color_button,iconColor:d.colors.$color_button_text,hoverBorderColor:d.colors.$color_white};var co=io;function uo(e){return Object(r.createElement)("iframe",P()({title:e.title},e))}uo.propTypes={title:l.a.string.isRequired};class po extends a.a.Component{componentDidUpdate(){this.props.hasFocus&&this.ref.focus()}setReference(e){this.ref=e}render(){return Object(r.createElement)("input",P()({ref:this.setReference.bind(this),type:this.props.type,name:this.props.name,defaultValue:this.props.value,onChange:this.props.onChange,autoComplete:this.props.autoComplete,className:this.props.className},this.props.optionalAttributes))}}po.propTypes={name:l.a.string.isRequired,type:l.a.oneOf(["button","checkbox","number","password","progress","radio","submit","text"]).isRequired,value:l.a.any,onChange:l.a.func,optionalAttributes:l.a.object,hasFocus:l.a.bool,autoComplete:l.a.string,className:l.a.string},po.defaultProps={name:"input",type:"text",value:"",hasFocus:!1,className:""};var ho=po,fo=o(29),bo=o.n(fo);class mo extends a.a.Component{constructor(e){super(e),this.state={words:[]}}static getDerivedStateFromProps(e){const t=[...e.words];t.sort((e,t)=>t.getOccurrences()-e.getOccurrences());const o=t.map(e=>e.getOccurrences()),r=Math.max(...o);return{words:t.map(e=>{const t=e.getOccurrences();return{name:e.getWord(),number:t,width:t/r*100}})}}render(){return Object(r.createElement)("div",null,this.props.header,this.props.introduction,Object(r.createElement)(ie,{items:this.state.words}),this.props.footer)}}mo.propTypes={words:l.a.array.isRequired,header:l.a.element,introduction:l.a.element,footer:l.a.element},mo.defaultProps={header:null,introduction:null,footer:null};var go=mo;const yo=e=>{let{words:t,researchArticleLink:o}=e;const n=Object(r.createElement)("p",{className:"yoast-field-group__title"},Object(U.__)("Prominent words","wordpress-seo")),a=Object(r.createElement)("p",null,0===t.length?Object(U.__)("Once you add a bit more copy, we'll give you a list of words that occur the most in the content. These give an indication of what your content focuses on.","wordpress-seo"):Object(U.__)("The following words occur the most in the content. These give an indication of what your content focuses on. If the words differ a lot from your topic, you might want to rewrite your content accordingly. ","wordpress-seo")),s=Object(r.createElement)("p",null,(e=>{const t=Object(U.sprintf)(Object(U.__)("Read our %1$sultimate guide to keyword research%2$s to learn more about keyword research and keyword strategy.","wordpress-seo"),"{{a}}","{{/a}}");return bo()({mixedString:t,components:{a:Object(r.createElement)("a",{href:e,target:"_blank"})}})})(o));return Object(r.createElement)(go,{words:t,header:n,introduction:a,footer:s})};yo.propTypes={words:l.a.arrayOf(l.a.object).isRequired,researchArticleLink:l.a.string.isRequired};var vo=yo;const xo=c.a.div`
	cursor: pointer;
	font-size: 14px;
	...
	color: #303030;
	font-weight: 500;
`,Oo=e=>Object(r.createElement)("label",P()({htmlFor:e.for,className:e.className},e.optionalAttributes),e.children);Oo.propTypes={for:l.a.string.isRequired,optionalAttributes:l.a.shape({"aria-label":l.a.string,onClick:l.a.func,className:l.a.string}),children:l.a.any.isRequired,className:l.a.string},Oo.defaultProps={className:"",optionalAttributes:{}};var Co=Oo;const wo=c.a.p`
	margin: 1em 0;
`,_o=Object(u.makeOutboundLink)(c.a.a`
	margin-left: 4px;
`);class jo extends n.PureComponent{render(){const{changeLanguageLink:e,canChangeLanguage:t,language:o,showLanguageNotice:n}=this.props;if(!n)return null;
...
`;class Po extends a.a.Component{render(){return Object(r.createElement)(qo,{role:"status","aria-live":"polite","aria-relevant":"additions text","aria-atomic":!0},Object(r.createElement)($o,null,this.props.steps.map(e=>{switch(e.status){case"running":return this.renderRunningState(e);case"failed":return this.renderFailedState(e);case"finished":return this.renderFinishedState(e);case"pending":default:return this.renderPendingState(e)}})))}renderPendingState(e){return Object(r.createElement)(Ro,{key:e.id},Object(r.createElement)("span",null,e.text))}renderRunningState(e){return Object(r.createElement)(Bo,{key:e.id},Object(r.createElement)("span",null,e.text),Object(r.createElement)(y,{icon:"loading-spinner"}))}renderFinishedState(e){return Object(r.createElement)(No,{key:e.id},Object(r.createElement)("span",null,e.text),Object(r.createElement)(y,{icon:"check",color:d.colors.$color_green_medium_light}))}renderFailedState(e){return Object(r.createElement)(No,{key:e.id},Object(r.createElement)("span",null,e.text),Object(r.createElement)(y,{icon:"times",color:d.colors.$color_red}))}}Po.defaultProps={steps:[]},Po.propTypes={steps:l.a.arrayOf(l.a.shape({status:l.a.oneOf(["pending","running","finished","failed"]).isRequired,text:l.a.string.isRequired,id:l.a.string.isRequired}))};var Io=Po;const zo=c.a.div`
	box-shadow: 0 1px 2px rgba(0, 0, 0, 0.2);
	background-color: ${e=>e.backgroundColor};
	min-height: ${e=>e.minHeight};
`;zo.propTypes={backgroundColor:l.a.string,minHeight:l.a.string},zo.defaultProps={backgroundColor:d.colors.$color_white,minHeight:"0"};var Mo=zo;const Lo=c.a.div`
	display: flex;
	align-items: center;
	padding: 24px;
...
`,Uo=c()(y)`
	vertical-align: middle;
`;function Ho(e){const t=""+e.headingLevel;return Object(r.createElement)(Mo,null,Object(r.createElement)(Lo,{isDismissable:e.isDismissable},e.imageSrc&&Object(r.createElement)(Do,{src:e.imageSrc,imageWidth:e.imageWidth,imageHeight:e.imageHeight,alt:""}),Object(r.createElement)(Ao,null,Object(r.createElement)(t,null,e.title),Object(r.createElement)("p",{className:"prova",dangerouslySetInnerHTML:{__html:e.html}})),e.isDismissable&&Object(r.createElement)(Fo,{onClick:e.onClick,type:"button","aria-label":Object(U.__)("Dismiss this notice","wordpress-seo")},Object(r.createElement)(Uo,{icon:"times",color:d.colors.$color_grey_text,size:"24px"}))))}Ho.propTypes={imageSrc:l.a.string,imageWidth:l.a.string,imageHeight:l.a.string,title:l.a.string,html:l.a.string,isDismissable:l.a.bool,onClick:l.a.func,headingLevel:l.a.string},Ho.defaultProps={isDismissable:!1,headingLevel:"h3"};var Wo=Ho;const Vo=c.a.progress`
	box-sizing: border-box;
	width: 100%;
	height: 8px;
	display: block;
...
`;Vo.defaultProps={max:1,value:0,progressColor:d.colors.$color_good,backgroundColor:d.colors.$color_background_light,borderColor:d.colors.$color_input_border,"aria-hidden":"true"},Vo.propTypes={max:l.a.number,value:l.a.number,progressColor:l.a.string,backgroundColor:l.a.string,borderColor:l.a.string,"aria-hidden":l.a.string};var Ko=Vo;const Go=c.a.li`
	display: table-row;
	font-size: 14px;
`,Yo=c.a.span`
	display: table-cell;
...
`,Jo=c()(Yo)`
	...
	text-align: right;
	padding-left: 16px;
`,Qo=e=>Object(r.createElement)(Go,{className:""+e.className},Object(r.createElement)(Zo,{className:e.className+"-bullet",scoreColor:e.scoreColor}),Object(r.createElement)(Xo,{className:e.className+"-text",dangerouslySetInnerHTML:{__html:e.html}}),e.value&&Object(r.createElement)(Jo,{className:e.className+"-score"},e.value));Qo.propTypes={className:l.a.string.isRequired,scoreColor:l.a.string.isRequired,html:l.a.string.isRequired,value:l.a.number};const er=c.a.ul`
	display: table;
	box-sizing: border-box;
	list-style: none;
	max-width: 100%;
...
`,hr=e=>{const{label:t,helpLink:o,...n}=e;return Object(r.createElement)(ir,null,Object(r.createElement)(ur,null,Object(r.createElement)(pr,{htmlFor:n.id},t),o),Object(r.createElement)(cr,P()({},n,{autoComplete:"off"})))};hr.propTypes={type:l.a.string,id:l.a.string.isRequired,label:l.a.string,helpLink:l.a.node},hr.defaultProps={type:"text",label:"",helpLink:null};var fr=hr;class br extends a.a.Component{render(){return Object(r.createElement)("textarea",P()({ref:this.setReference.bind(this),name:this.props.name,value:this.props.value,onChange:this.props.onChange},this.props.optionalAttributes))}setReference(e){this.ref=e}componentDidUpdate(){this.props.hasFocus&&this.ref.focus()}}br.propTypes={name:l.a.string.isRequired,value:l.a.string,onChange:l.a.func,optionalAttributes:l.a.object,hasFocus:l.a.bool},br.defaultProps={name:"textarea",value:"",hasFocus:!1};var mr=br;class gr extends a.a.Component{constructor(e){super(e),this.optionalAttributes=this.parseOptionalAttributes()}render(){return this.optionalAttributes=this.parseOptionalAttributes(),this.props.class&&(this.optionalAttributes.container.className=this.props.class),Object(r.createElement)("div",this.optionalAttributes.container,Object(r.createElement)(Co,{for:this.props.name,optionalAttributes:this.optionalAttributes.label},this.props.label),this.getTextField())}getTextField(){return!0===this.props.multiline?Object(r.createElement)("div",null,Object(r.createElement)(mr,{name:this.props.name,id:this.props.name,onChange:this.props.onChange,optionalAttributes:this.optionalAttributes.field,hasFocus:this.props.hasFocus,value:this.props.value}),this.props.explanation&&Object(r.createElement)("p",null,this.props.explanation)):Object(r.createElement)("div",null,Object(r.createElement)(ho,{name:this.props.name,id:this.props.name,type:"text",onChange:this.props.onChange,value:this.props.value,hasFocus:this.props.hasFocus,autoComplete:this.props.autoComplete,optionalAttributes:this.optionalAttributes.field}),this.props.explanation&&Object(r.createElement)("p",null,this.props.explanation))}parseOptionalAttributes(){const e={},t={},o={id:this.props.name};return Object.keys(this.props).forEach(function(r){r.startsWith("label-")&&(t[r.split("-").pop()]=this.props[r]),r.startsWith("field-")&&(o[r.split("-").pop()]=this.props[r]),r.startsWith("container-")&&(e[r.split("-").pop()]=this.props[r])}.bind(this)),{label:t,field:o,container:e}}}gr.propTypes={label:l.a.string.isRequired,name:l.a.string.isRequired,onChange:l.a.func.isRequired,value:l.a.string,optionalAttributes:l.a.object,multiline:l.a.bool,hasFocus:l.a.bool,class:l.a.string,explanation:l.a.string,autoComplete:l.a.string},gr.defaultProps={optionalAttributes:{},multiline:!1,hasFocus:!1};var yr=gr;const vr=c.a.div`
	display: flex;
	width: 100%;
...
`,qr=($r=c()(kr)`
	...
	`);var $r;qr.propTypes={backgroundColor:l.a.string,hoverColor:l.a.string,textColor:l.a.string},qr.defaultProps={backgroundColor:d.colors.$color_button_upsell,hoverColor:d.colors.$color_button_hover_upsell,textColor:d.colors.$color_black};const Nr=e=>{const{children:t}=e;return Object(r.createElement)(qr,e,t,Object(r.createElement)(Tr,{icon:"caret-right",color:d.colors.$color_black,size:"16px"}))};Nr.propTypes={backgroundColor:l.a.string,hoverColor:l.a.string,textColor:l.a.string,children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node])};const Rr=c.a.a`
	align-items: center;
	justify-content: center;
	vertical-align: middle;
	color: ${d.colors.$color_black};
...
`;Tn.propTypes={children:l.a.any};class qn extends a.a.Component{constructor(e){super(e)}getChildren(){return 1===this.props.children?[this.props.children]:this.props.children}render(){const e=this.getChildren();return Object(r.createElement)(Tn,{role:"list"},e)}}class $n extends qn{constructor(e){super(e),this.zebraProps=Object.assign({},e)}zebrafyChildren(){let e=this.props.children;this.props.children.map||(e=[e]),this.zebraProps.children=e.map((e,t)=>a.a.cloneElement(e,{background:t%2==1?d.colors.$color_white:d.colors.$color_background_light,key:t}))}render(){return this.zebrafyChildren(),Object(r.createElement)(Tn,P()({role:"list"},this.zebraProps))}}qn.propTypes={children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node])};const Nn=c.a.li`

...
`,C=e=>Object(r.createElement)(O,{className:e.className,headingColor:e.headingColor,hasPaperStyle:e.hasPaperStyle},e.headingText&&Object(r.createElement)(v,{level:e.headingLevel,className:e.headingClassName},e.headingIcon&&Object(r.createElement)(x,{icon:e.headingIcon,color:e.headingIconColor,size:e.headingIconSize}),e.headingText),e.children);C.propTypes={className:l.a.string,headingLevel:l.a.number,headingClassName:l.a.string,headingColor:l.a.string,headingIcon:l.a.string,headingIconColor:l.a.string,headingIconSize:l.a.string,headingText:l.a.string,hasPaperStyle:l.a.bool,children:l.a.any},C.defaultProps={className:"yoast-section",headingLevel:2,hasPaperStyle:!0};var w=C,_=o(101),j=o.n(_);function E(e){return c()(e)`
		display: inline-flex;
		align-items: center;
...
`,tt=c.a.span`
	...
	font-size: 0.8125rem;
	margin-top: 2px;
`,ot=e=>Object(r.createElement)(Qe,null,Object(r.createElement)(et,null,e.title,e.titleScreenReaderText&&Object(r.createElement)(Je,null," "+e.titleScreenReaderText)),e.subTitle&&Object(r.createElement)(tt,null,e.subTitle));ot.propTypes={title:l.a.string.isRequired,titleScreenReaderText:l.a.string,subTitle:l.a.string};const rt=c.a.div`
	padding: 0 16px;
	margin-bottom: 16px;
`,nt=c.a.div`
...
`;function lt(e,t){const o="h"+t.level,n=c()(o)`
		margin: 0 !important;
		padding: 0 !important;
		font-size: ${t.fontSize} !important;
		font-weight: ${t.fontWeight} !important;
	`;return function(t){return Object(r.createElement)(n,null,Object(r.createElement)(e,t))}}const it=lt(st,{level:2,fontSize:"1rem",fontWeight:"normal"});function ct(e){let t=null;e.isOpen&&(t=e.hasPadding?Object(r.createElement)(rt,{className:"collapsible_content"},e.children):e.children);const o=e.hasSeparator?at:nt;return Object(r.createElement)(o,{className:e.className},Object(r.createElement)(e.Heading,{id:e.id,"aria-expanded":e.isOpen,onClick:e.onToggle,prefixIcon:e.isOpen?e.prefixIcon:e.prefixIconCollapsed,suffixIcon:e.isOpen?e.suffixIcon:e.suffixIconCollapsed,hasSubTitle:!!e.subTitle},Object(r.createElement)(ot,{title:e.title,titleScreenReaderText:e.titleScreenReaderText,subTitle:e.subTitle})),t)}ct.propTypes={children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node]),className:l.a.string,Heading:l.a.func,isOpen:l.a.bool.isRequired,hasSeparator:l.a.bool,hasPadding:l.a.bool,initialIsOpen:l.a.bool,onToggle:l.a.func.isRequired,prefixIcon:l.a.shape({icon:l.a.string,color:l.a.string,size:l.a.string}),prefixIconCollapsed:l.a.shape({icon:l.a.string,color:l.a.string,size:l.a.string}),subTitle:l.a.string,suffixIcon:l.a.shape({icon:l.a.string,color:l.a.string,size:l.a.string}),suffixIconCollapsed:l.a.shape({icon:l.a.string,color:l.a.string,size:l.a.string}),title:l.a.string.isRequired,titleScreenReaderText:l.a.string,id:l.a.string},ct.defaultProps={Heading:it,id:null,children:null,className:null,subTitle:null,titleScreenReaderText:null,hasSeparator:!1,hasPadding:!1,initialIsOpen:!1,prefixIcon:null,prefixIconCollapsed:null,suffixIcon:null,suffixIconCollapsed:null};class dt extends a.a.Component{constructor(e){super(e),this.state={isOpen:e.initialIsOpen,headingProps:e.headingProps,Heading:lt(st,e.headingProps)},this.toggleCollapse=this.toggleCollapse.bind(this)}static getDerivedStateFromProps(e,t){return e.headingProps.level!==t.headingProps.level||e.headingProps.fontSize!==t.headingProps.fontSize||e.headingProps.fontWeight!==t.headingProps.fontWeight?{...t,headingProps:e.headingProps,Heading:lt(st,e.headingProps)}:null}toggleCollapse(){const{isOpen:e}=this.state,{onToggle:t}=this.props;t&&!1===t(e)||this.setState({isOpen:!e})}render(){const{isOpen:e}=this.state,{children:t}=this.props,o=Object(Oe.omit)(this.props,["children","onToggle"]);return Object(r.createElement)(ct,B()({Heading:this.state.Heading,isOpen:e,onToggle:this.toggleCollapse},o),e&&t)}}dt.propTypes={children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node]),className:l.a.string,initialIsOpen:l.a.bool,hasSeparator:l.a.bool,hasPadding:l.a.bool,prefixIcon:l.a.shape({icon:l.a.string,color:l.a.string,size:l.a.string}),prefixIconCollapsed:l.a.shape({icon:l.a.string,color:l.a.string,size:l.a.string}),suffixIcon:l.a.shape({icon:l.a.string,color:l.a.string,size:l.a.string}),suffixIconCollapsed:l.a.shape({icon:l.a.string,color:l.a.string,size:l.a.string}),title:l.a.string.isRequired,titleScreenReaderText:l.a.string,subTitle:l.a.string,headingProps:l.a.shape({level:l.a.number,fontSize:l.a.string,fontWeight:l.a.string}),onToggle:l.a.func},dt.defaultProps={hasSeparator:!1,hasPadding:!1,initialIsOpen:!1,subTitle:null,titleScreenReaderText:null,children:null,className:null,prefixIcon:null,prefixIconCollapsed:null,suffixIcon:{icon:"chevron-up",color:d.colors.$black,size:"24px"},suffixIconCollapsed:{icon:"chevron-down",color:d.colors.$black,size:"24px"},headingProps:{level:2,fontSize:"1rem",fontWeight:"normal"},onToggle:null};var ut=dt;const pt=c.a.div`
	box-sizing: border-box;
...
`,ft=c.a.ul`
	...
	list-style: none;
	padding: 0;
`,bt=Object(u.makeOutboundLink)(c.a.a`
	display: inline-block;
	margin-bottom: 4px;
	font-size: 14px;
`),mt=c.a.li`
...
`,yt=e=>Object(r.createElement)(mt,{className:e.className},Object(r.createElement)(bt,{className:e.className+"-link",href:e.link},e.title),Object(r.createElement)("p",{className:e.className+"-description"},e.description));yt.propTypes={className:l.a.string.isRequired,title:l.a.string.isRequired,link:l.a.string.isRequired,description:l.a.string.isRequired};const vt=e=>Object(r.createElement)(pt,{className:e.className},Object(r.createElement)(ht,{className:e.className+"__header"},e.title?e.title:e.feed.title),Object(r.createElement)(ft,{className:e.className+"__posts",role:"list"},e.feed.items.map(t=>Object(r.createElement)(yt,{className:e.className+"__post",key:t.link,title:t.title,link:t.link,description:t.description}))),e.footerLinkText&&Object(r.createElement)(gt,{className:e.className+"__footer"},Object(r.createElement)(bt,{className:e.className+"__footer-link",href:e.feedLink?e.feedLink:e.feed.link},e.footerLinkText)));vt.propTypes={className:l.a.string,feed:l.a.object.isRequired,title:l.a.string,footerLinkText:l.a.string,feedLink:l.a.string},vt.defaultProps={className:"articlelist-feed"};var xt=vt;const Ot=c.a.span`
	position: absolute;
...
`;function wt(e){return Object(r.createElement)(n.Fragment,null,Object(r.createElement)(Ot,{backgroundColor:e.backgroundColor,textColor:e.textColor},e.children),Object(r.createElement)(Ct,null))}wt.propTypes={backgroundColor:l.a.string,textColor:l.a.string,children:l.a.any},wt.defaultProps={backgroundColor:d.colors.$color_pink_dark,textColor:d.colors.$color_white,children:null};const _t=c.a.div`
	position: relative;
	display: flex;
...
`,St=c.a.h2`
	...
	line-height: 1.2;
	color: currentColor;
`,Tt=Object(u.makeOutboundLink)(kt);class qt extends a.a.Component{getHeader(){return this.props.header?this.props.header.link?Object(r.createElement)(Tt,{href:this.props.header.link},Object(r.createElement)(jt,{src:this.props.header.image,alt:""}),Object(r.createElement)(St,null,this.props.header.title)):Object(r.createElement)(n.Fragment,null,Object(r.createElement)(jt,{src:this.props.header.image,alt:""}),";",Object(r.createElement)(St,null,this.props.header.title)):null}getBanner(){return this.props.banner?Object(r.createElement)(wt,this.props.banner,this.props.banner.text):null}render(){return Object(r.createElement)(_t,{className:this.props.className,id:this.props.id},this.getHeader(),this.getBanner(),Object(r.createElement)(Et,null,this.props.children))}}var $t=qt;const Nt=c()(qt)`
	height: 100%;
`;qt.propTypes={className:l.a.string,id:l.a.string,header:l.a.shape({title:l.a.string,image:l.a.string.isRequired,link:l.a.string}),banner:l.a.shape({text:l.a.string.isRequired,textColor:l.a.string,backgroundColor:l.a.string}),children:l.a.any},qt.defaultProps={className:"",id:"",header:null,banner:null,children:null};const Rt=c.a.a`
...
`,Bt=c.a.a`
	font-weight: bold;
`,It=Object(u.makeOutboundLink)(Bt),zt=c.a.div`
	text-align: center;
`,Mt=c.a.div`
	ul {
...
`,Lt=c.a.div`
	...
	flex-grow: 1;
`;class Dt extends a.a.Component{getActionBlock(e,t){const o=Object(u.makeOutboundLink)(e);return"true"===t?Object(r.createElement)(zt,null,Object(r.createElement)(o,{href:this.props.courseUrl},this.props.ctaButtonData.ctaButtonCopy)):Object(r.createElement)(zt,null,Object(r.createElement)(o,{href:this.props.ctaButtonData.ctaButtonUrl},this.props.ctaButtonData.ctaButtonCopy),Object(r.createElement)(It,{href:this.props.courseUrl},this.props.readMoreLinkText))}render(){const e="regular"===this.props.ctaButtonData.ctaButtonType?Rt:Pt;return Object(r.createElement)(n.Fragment,null,Object(r.createElement)(Lt,null,Object(r.createElement)(Mt,{dangerouslySetInnerHTML:{__html:this.props.description}})),this.getActionBlock(e,this.props.isBundle))}}var At=Dt;Dt.propTypes={description:l.a.string,courseUrl:l.a.string,ctaButtonData:l.a.object,readMoreLinkText:l.a.string,isBundle:l.a.string},Dt.defaultProps={description:"",courseUrl:"",ctaButtonData:{},readMoreLinkText:"",isBundle:""};var Ft=o(36),Ut=o.n(Ft);const Ht=j()([T,k,S])(c.a.button`
		display: inline-flex;
		flex-direction: column;
		justify-content: center;
		align-items: center;
	...
	`),Wt=e=>{const{children:t,icon:o,textColor:n}=e,a=Ut()(e,"icon");return Object(r.createElement)(Ht,a,Object(r.createElement)(y,{icon:o,color:n}),t)};Wt.propTypes={type:l.a.string,icon:l.a.string.isRequired,textColor:l.a.string,textFontSize:l.a.string,backgroundColor:l.a.string,borderColor:l.a.string,hoverColor:l.a.string,hoverBackgroundColor:l.a.string,hoverBorderColor:l.a.string,activeColor:l.a.string,activeBackgroundColor:l.a.string,activeBorderColor:l.a.string,focusColor:l.a.string,focusBackgroundColor:l.a.string,focusBorderColor:l.a.string,focusBoxShadowColor:l.a.string,children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node,l.a.string]).isRequired},Wt.defaultProps={type:"button",textColor:d.colors.$color_blue,textFontSize:"inherit",backgroundColor:"transparent",borderColor:"transparent",hoverColor:d.colors.$color_white,hoverBackgroundColor:d.colors.$color_blue,hoverBorderColor:d.colors.$color_button_border_hover,activeColor:d.colors.$color_white,activeBackgroundColor:d.colors.$color_blue,activeBorderColor:d.colors.$color_button_border_active,focusColor:d.colors.$color_white,focusBackgroundColor:d.colors.$color_blue,focusBorderColor:d.colors.$color_blue,focusBoxShadowColor:d.colors.$color_blue_dark};var Vt=Wt;const Kt=e=>{const{children:t,icon:o,iconColor:n}=e;let a=y;t&&(a=function(e){return c()(e)`
		margin: ${Object(u.getDirectionalStyle)("0 8px 0 0","0 0 0 8px")};
		flex-shrink: 0;
	`}(a));const s=Ut()(e,"icon");return Object(r.createElement)(N,s,Object(r.createElement)(a,{icon:o,color:n}),t)};Kt.propTypes={icon:l.a.string.isRequired,iconColor:l.a.string,children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node,l.a.string])},Kt.defaultProps={iconColor:"#000"};var Gt=Kt,Yt=o(37);const Zt=c.a.p`
	text-align: center;
	margin: 0 0 16px;
	padding: 16px 16px 8px 16px;
	border-bottom: 4px solid ${d.colors.$color_bad};
	background: ${d.colors.$color_white};
`;class Xt extends a.a.Component{constructor(e){super(e),this.state={hasError:!1}}componentDidCatch(){this.setState({hasError:!0})}render(){if(this.state.hasError){const e=Object(U.__)("Something went wrong. Please reload the page.","wordpress-seo");return Object(Yt.speak)(e,"assertive"),Object(r.createElement)(Zt,null,e)}return this.props.children}}Xt.propTypes={children:l.a.any};const Jt=c.a.p`
	color: ${e=>e.textColor};
	font-size: ${e=>e.textFontSize};
	margin-top: 0;
`;class Qt extends n.PureComponent{render(){const{children:e,textColor:t,textFontSize:o}=this.props;return Object(r.createElement)(Jt,{textColor:t,textFontSize:o},e)}}const eo={children:l.a.oneOfType([l.a.string,l.a.array]),textColor:l.a.string,textFontSize:l.a.string};Qt.propTypes={...eo,children:eo.children.isRequired},Qt.defaultProps={textColor:d.colors.$color_help_text};const to=e=>{const t=c()(e.icon)`
		width: ${e.width};
		height: ${e.height};
		${e.color?`fill: ${e.color};`:""}
		flex: 0 0 auto;
	`,o=Ut()(e,["icon","width","height","color"]);return Object(r.createElement)(t,B()({role:"img","aria-hidden":"true",focusable:"false"},o))};to.propTypes={icon:l.a.func.isRequired,width:l.a.string,height:l.a.string,color:l.a.string},to.defaultProps={width:"16px",height:"16px"};var oo=to;const ro=c.a.button`
	box-sizing: border-box;
	min-width: 32px;
	display: inline-block;
...
`,no=function(e){return"disabled"===e.marksButtonStatus},ao=function(e){return Object(r.createElement)(ro,{disabled:no(e),type:"button",onClick:e.onClick,pressed:e.pressed,unpressedBoxShadowColor:e.unpressedBoxShadowColor,pressedBoxShadowColor:e.pressedBoxShadowColor,pressedBackground:e.pressedBackground,unpressedBackground:e.unpressedBackground,id:e.id,"aria-label":e.ariaLabel,"aria-pressed":e.pressed,unpressedIconColor:no(e)?e.disabledIconColor:e.unpressedIconColor,pressedIconColor:e.pressedIconColor,hoverBorderColor:e.hoverBorderColor,className:e.className},no(e)&&Object(r.createElement)(y,{icon:e.icon,color:e.disabledIconColor,size:"18px"}),!e.pressed&&!no(e)&&Object(r.createElement)(y,{icon:e.icon,color:e.unpressedIconColor,size:"18px"}),e.pressed&&!no(e)&&Object(r.createElement)(y,{icon:e.icon,color:e.pressedIconColor,size:"18px"}))};ao.propTypes={id:l.a.string.isRequired,ariaLabel:l.a.string.isRequired,onClick:l.a.func.isRequired,boxShadowColor:l.a.string,unpressedBoxShadowColor:l.a.string,pressedBoxShadowColor:l.a.string,pressedBackground:l.a.string,unpressedBackground:l.a.string,pressedIconColor:l.a.string,unpressedIconColor:l.a.string,icon:l.a.string.isRequired,pressed:l.a.bool.isRequired,hoverBorderColor:l.a.string,marksButtonStatus:l.a.string,disabledIconColor:l.a.string,className:l.a.string},ao.defaultProps={unpressedBoxShadowColor:d.colors.$color_button_border,pressedBoxShadowColor:d.colors.$color_purple,pressedBackground:d.colors.$color_pink_dark,unpressedBackground:d.colors.$color_button,pressedIconColor:d.colors.$color_white,unpressedIconColor:d.colors.$color_button_text,hoverBorderColor:d.colors.$color_white,marksButtonStatus:"enabled",disabledIconColor:d.colors.$color_grey};var so=ao;function lo(e){return Object(r.createElement)("iframe",B()({title:e.title},e))}lo.propTypes={title:l.a.string.isRequired};class io extends a.a.Component{componentDidUpdate(){this.props.hasFocus&&this.ref.focus()}setReference(e){this.ref=e}render(){return Object(r.createElement)("input",B()({ref:this.setReference.bind(this),type:this.props.type,name:this.props.name,defaultValue:this.props.value,onChange:this.props.onChange,autoComplete:this.props.autoComplete,className:this.props.className},this.props.optionalAttributes))}}io.propTypes={name:l.a.string.isRequired,type:l.a.oneOf(["button","checkbox","number","password","progress","radio","submit","text"]).isRequired,value:l.a.any,onChange:l.a.func,optionalAttributes:l.a.object,hasFocus:l.a.bool,autoComplete:l.a.string,className:l.a.string},io.defaultProps={name:"input",type:"text",value:"",hasFocus:!1,className:""};var co=io,uo=o(29),po=o.n(uo);class ho extends a.a.Component{constructor(e){super(e),this.state={words:[]}}static getDerivedStateFromProps(e){const t=[...e.words];t.sort((e,t)=>t.getOccurrences()-e.getOccurrences());const o=t.map(e=>e.getOccurrences()),r=Math.max(...o);return{words:t.map(e=>{const t=e.getOccurrences();return{name:e.getWord(),number:t,width:t/r*100}})}}render(){return Object(r.createElement)("div",null,this.props.header,this.props.introduction,Object(r.createElement)(ie,{items:this.state.words}),this.props.footer)}}ho.propTypes={words:l.a.array.isRequired,header:l.a.element,introduction:l.a.element,footer:l.a.element},ho.defaultProps={header:null,introduction:null,footer:null};var fo=ho;const bo=e=>{let{words:t,researchArticleLink:o}=e;const n=Object(r.createElement)("p",{className:"yoast-field-group__title"},Object(U.__)("Prominent words","wordpress-seo")),a=Object(r.createElement)("p",null,0===t.length?Object(U.__)("Once you add a bit more copy, we'll give you a list of words that occur the most in the content. These give an indication of what your content focuses on.","wordpress-seo"):Object(U.__)("The following words occur the most in the content. These give an indication of what your content focuses on. If the words differ a lot from your topic, you might want to rewrite your content accordingly. ","wordpress-seo")),s=Object(r.createElement)("p",null,(e=>{const t=Object(U.sprintf)(Object(U.__)("Read our %1$sultimate guide to keyword research%2$s to learn more about keyword research and keyword strategy.","wordpress-seo"),"{{a}}","{{/a}}");return po()({mixedString:t,components:{a:Object(r.createElement)("a",{href:e,target:"_blank"})}})})(o));return Object(r.createElement)(fo,{words:t,header:n,introduction:a,footer:s})};bo.propTypes={words:l.a.arrayOf(l.a.object).isRequired,researchArticleLink:l.a.string.isRequired};var mo=bo;const go=c.a.div`
	cursor: pointer;
	font-size: 14px;
	...
	color: #303030;
	font-weight: 500;
`,yo=e=>Object(r.createElement)("label",B()({htmlFor:e.for,className:e.className},e.optionalAttributes),e.children);yo.propTypes={for:l.a.string.isRequired,optionalAttributes:l.a.shape({"aria-label":l.a.string,onClick:l.a.func,className:l.a.string}),children:l.a.any.isRequired,className:l.a.string},yo.defaultProps={className:"",optionalAttributes:{}};var vo=yo;const xo=c.a.p`
	margin: 1em 0;
`,Oo=Object(u.makeOutboundLink)(c.a.a`
	margin-left: 4px;
`);class Co extends n.PureComponent{render(){const{changeLanguageLink:e,canChangeLanguage:t,language:o,showLanguageNotice:n}=this.props;if(!n)return null;
...
`;class No extends a.a.Component{render(){return Object(r.createElement)(ko,{role:"status","aria-live":"polite","aria-relevant":"additions text","aria-atomic":!0},Object(r.createElement)(So,null,this.props.steps.map(e=>{switch(e.status){case"running":return this.renderRunningState(e);case"failed":return this.renderFailedState(e);case"finished":return this.renderFinishedState(e);case"pending":default:return this.renderPendingState(e)}})))}renderPendingState(e){return Object(r.createElement)(qo,{key:e.id},Object(r.createElement)("span",null,e.text))}renderRunningState(e){return Object(r.createElement)($o,{key:e.id},Object(r.createElement)("span",null,e.text),Object(r.createElement)(y,{icon:"loading-spinner"}))}renderFinishedState(e){return Object(r.createElement)(To,{key:e.id},Object(r.createElement)("span",null,e.text),Object(r.createElement)(y,{icon:"check",color:d.colors.$color_green_medium_light}))}renderFailedState(e){return Object(r.createElement)(To,{key:e.id},Object(r.createElement)("span",null,e.text),Object(r.createElement)(y,{icon:"times",color:d.colors.$color_red}))}}No.defaultProps={steps:[]},No.propTypes={steps:l.a.arrayOf(l.a.shape({status:l.a.oneOf(["pending","running","finished","failed"]).isRequired,text:l.a.string.isRequired,id:l.a.string.isRequired}))};var Ro=No;const Po=c.a.div`
	box-shadow: 0 1px 2px rgba(0, 0, 0, 0.2);
	background-color: ${e=>e.backgroundColor};
	min-height: ${e=>e.minHeight};
`;Po.propTypes={backgroundColor:l.a.string,minHeight:l.a.string},Po.defaultProps={backgroundColor:d.colors.$color_white,minHeight:"0"};var Bo=Po;const Io=c.a.div`
	display: flex;
	align-items: center;
	padding: 24px;
...
`,Do=c()(y)`
	vertical-align: middle;
`;function Ao(e){const t=""+e.headingLevel;return Object(r.createElement)(Bo,null,Object(r.createElement)(Io,{isDismissable:e.isDismissable},e.imageSrc&&Object(r.createElement)(zo,{src:e.imageSrc,imageWidth:e.imageWidth,imageHeight:e.imageHeight,alt:""}),Object(r.createElement)(Mo,null,Object(r.createElement)(t,null,e.title),Object(r.createElement)("p",{className:"prova",dangerouslySetInnerHTML:{__html:e.html}})),e.isDismissable&&Object(r.createElement)(Lo,{onClick:e.onClick,type:"button","aria-label":Object(U.__)("Dismiss this notice","wordpress-seo")},Object(r.createElement)(Do,{icon:"times",color:d.colors.$color_grey_text,size:"24px"}))))}Ao.propTypes={imageSrc:l.a.string,imageWidth:l.a.string,imageHeight:l.a.string,title:l.a.string,html:l.a.string,isDismissable:l.a.bool,onClick:l.a.func,headingLevel:l.a.string},Ao.defaultProps={isDismissable:!1,headingLevel:"h3"};var Fo=Ao;const Uo=c.a.progress`
	box-sizing: border-box;
	width: 100%;
	height: 8px;
	display: block;
...
`;Uo.defaultProps={max:1,value:0,progressColor:d.colors.$color_good,backgroundColor:d.colors.$color_background_light,borderColor:d.colors.$color_input_border,"aria-hidden":"true"},Uo.propTypes={max:l.a.number,value:l.a.number,progressColor:l.a.string,backgroundColor:l.a.string,borderColor:l.a.string,"aria-hidden":l.a.string};var Ho=Uo;const Wo=c.a.li`
	display: table-row;
	font-size: 14px;
`,Vo=c.a.span`
	display: table-cell;
...
`;Ko.propTypes={scoreColor:l.a.string.isRequired};const Go=c()(Vo)`
	padding-left: 8px;
	width: 100%;
`,Yo=c()(Vo)`
	font-weight: 600;
	text-align: right;
	padding-left: 16px;
`,Zo=e=>Object(r.createElement)(Wo,{className:""+e.className},Object(r.createElement)(Ko,{className:e.className+"-bullet",scoreColor:e.scoreColor}),Object(r.createElement)(Go,{className:e.className+"-text",dangerouslySetInnerHTML:{__html:e.html}}),e.value&&Object(r.createElement)(Yo,{className:e.className+"-score"},e.value));Zo.propTypes={className:l.a.string.isRequired,scoreColor:l.a.string.isRequired,html:l.a.string.isRequired,value:l.a.number};const Xo=c.a.ul`
	display: table;
	box-sizing: border-box;
	list-style: none;
	max-width: 100%;
	...
	margin: 8px 0;
	padding: 0 8px;
`,Jo=e=>Object(r.createElement)(Xo,{className:e.className,role:"list"},e.items.map((t,o)=>Object(r.createElement)(Zo,{className:e.className+"__item",key:o,scoreColor:t.color,html:t.html,value:t.value})));Jo.propTypes={className:l.a.string,items:l.a.arrayOf(l.a.shape({color:l.a.string.isRequired,html:l.a.string.isRequired,value:l.a.number}))},Jo.defaultProps={className:"score-assessments"};var Qo=Jo;const er=c.a.div`
	margin: 8px 0;
...
`,tr=c.a.span`
	...
	background-color: ${e=>e.progressColor};
	height: 100%;
`;tr.propTypes={progressWidth:l.a.number.isRequired,progressColor:l.a.string.isRequired};const or=e=>{let t=0;for(let o=0;o<e.items.length;o++)e.items[o].value=Math.max(e.items[o].value,0),t+=e.items[o].value;return t<=0?null:Object(r.createElement)(er,{className:e.className,barHeight:e.barHeight},e.items.map((o,n)=>Object(r.createElement)(tr,{className:e.className+"__part",key:n,progressColor:o.color,progressWidth:o.value/t*100})))};or.propTypes={className:l.a.string,items:l.a.arrayOf(l.a.shape({value:l.a.number.isRequired,color:l.a.string.isRequired})),barHeight:l.a.string},or.defaultProps={className:"stacked-progress-bar",barHeight:"24px"};var rr=or;const nr=c.a.div.attrs({})`
	flex: 0 1 100%;
...
`,dr=e=>{const{label:t,helpLink:o,...n}=e;return Object(r.createElement)(ar,null,Object(r.createElement)(ir,null,Object(r.createElement)(cr,{htmlFor:n.id},t),o),Object(r.createElement)(sr,B()({},n,{autoComplete:"off"})))};dr.propTypes={type:l.a.string,id:l.a.string.isRequired,label:l.a.string,helpLink:l.a.node},dr.defaultProps={type:"text",label:"",helpLink:null};var ur=dr;class pr extends a.a.Component{render(){return Object(r.createElement)("textarea",B()({ref:this.setReference.bind(this),name:this.props.name,value:this.props.value,onChange:this.props.onChange},this.props.optionalAttributes))}setReference(e){this.ref=e}componentDidUpdate(){this.props.hasFocus&&this.ref.focus()}}pr.propTypes={name:l.a.string.isRequired,value:l.a.string,onChange:l.a.func,optionalAttributes:l.a.object,hasFocus:l.a.bool},pr.defaultProps={name:"textarea",value:"",hasFocus:!1};var hr=pr;class fr extends a.a.Component{constructor(e){super(e),this.optionalAttributes=this.parseOptionalAttributes()}render(){return this.optionalAttributes=this.parseOptionalAttributes(),this.props.class&&(this.optionalAttributes.container.className=this.props.class),Object(r.createElement)("div",this.optionalAttributes.container,Object(r.createElement)(vo,{for:this.props.name,optionalAttributes:this.optionalAttributes.label},this.props.label),this.getTextField())}getTextField(){return!0===this.props.multiline?Object(r.createElement)("div",null,Object(r.createElement)(hr,{name:this.props.name,id:this.props.name,onChange:this.props.onChange,optionalAttributes:this.optionalAttributes.field,hasFocus:this.props.hasFocus,value:this.props.value}),this.props.explanation&&Object(r.createElement)("p",null,this.props.explanation)):Object(r.createElement)("div",null,Object(r.createElement)(co,{name:this.props.name,id:this.props.name,type:"text",onChange:this.props.onChange,value:this.props.value,hasFocus:this.props.hasFocus,autoComplete:this.props.autoComplete,optionalAttributes:this.optionalAttributes.field}),this.props.explanation&&Object(r.createElement)("p",null,this.props.explanation))}parseOptionalAttributes(){const e={},t={},o={id:this.props.name};return Object.keys(this.props).forEach(function(r){r.startsWith("label-")&&(t[r.split("-").pop()]=this.props[r]),r.startsWith("field-")&&(o[r.split("-").pop()]=this.props[r]),r.startsWith("container-")&&(e[r.split("-").pop()]=this.props[r])}.bind(this)),{label:t,field:o,container:e}}}fr.propTypes={label:l.a.string.isRequired,name:l.a.string.isRequired,onChange:l.a.func.isRequired,value:l.a.string,optionalAttributes:l.a.object,multiline:l.a.bool,hasFocus:l.a.bool,class:l.a.string,explanation:l.a.string,autoComplete:l.a.string},fr.defaultProps={optionalAttributes:{},multiline:!1,hasFocus:!1};var br=fr;const mr=c.a.div`
	display: flex;
	width: 100%;
...
`,xr=c.a.span`
	...
	font-style: italic;
`;class Or extends a.a.Component{constructor(e){super(e),this.onClick=this.props.onToggleDisabled,this.onKeyUp=this.props.onToggleDisabled,this.setToggleState=this.setToggleState.bind(this),this.handleOnKeyDown=this.handleOnKeyDown.bind(this),!0!==e.disable&&(this.onClick=this.setToggleState.bind(this),this.onKeyUp=this.setToggleState.bind(this))}setToggleState(e){"keyup"===e.type&&32!==e.keyCode||this.props.onSetToggleState(!this.props.isEnabled)}handleOnKeyDown(e){32===e.keyCode&&e.preventDefault()}render(){return Object(r.createElement)(mr,null,this.props.labelText&&Object(r.createElement)(gr,{id:this.props.id,onClick:this.onClick},this.props.labelText),Object(r.createElement)(yr,{isEnabled:this.props.isEnabled,onKeyDown:this.handleOnKeyDown,onClick:this.onClick,onKeyUp:this.onKeyUp,tabIndex:"0",role:"checkbox","aria-labelledby":this.props.id,"aria-checked":this.props.isEnabled,"aria-disabled":this.props.disable},Object(r.createElement)(vr,{isEnabled:this.props.isEnabled})),this.props.showToggleStateLabel&&Object(r.createElement)(xr,{"aria-hidden":"true"},this.props.isEnabled?Object(U.__)("On","wordpress-seo"):Object(U.__)("Off","wordpress-seo")))}}Or.propTypes={isEnabled:l.a.bool,onSetToggleState:l.a.func,disable:l.a.bool,onToggleDisabled:l.a.func,id:l.a.string.isRequired,labelText:l.a.string.isRequired,showToggleStateLabel:l.a.bool},Or.defaultProps={isEnabled:!1,onSetToggleState:()=>{},labelText:"",disable:!1,onToggleDisabled:()=>{},showToggleStateLabel:!0};var Cr=Or;function wr(e){return c()(e)`
		display: inline-flex;
		align-items: center;
		justify-content: center;
		vertical-align: middle;
	...
	`}const _r=e=>{let{className:t,onClick:o,type:n,children:a,isExpanded:s}=e;return Object(r.createElement)("button",{className:t,onClick:o,type:n,"aria-expanded":s},Object(r.createElement)("span",null,a))};_r.propTypes={className:l.a.string,onClick:l.a.func,type:l.a.string,isExpanded:l.a.bool,children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node,l.a.string])},_r.defaultProps={type:"button"};const jr=wr(c()(_r)`
		color: ${e=>e.textColor};
		background: ${e=>e.backgroundColor};
		min-width: 152px;
	...
	`);jr.propTypes={backgroundColor:l.a.string,textColor:l.a.string,withTextShadow:l.a.bool},jr.defaultProps={backgroundColor:d.colors.$color_green_medium_light,textColor:d.colors.$color_white,withTextShadow:!0};const Er=c()(y)`
...
`,kr=(Sr=c()(_r)`
	...
	`);var Sr;kr.propTypes={backgroundColor:l.a.string,hoverColor:l.a.string,textColor:l.a.string},kr.defaultProps={backgroundColor:d.colors.$color_button_upsell,hoverColor:d.colors.$color_button_hover_upsell,textColor:d.colors.$color_black};const Tr=e=>{const{children:t}=e;return Object(r.createElement)(kr,e,t,Object(r.createElement)(Er,{icon:"caret-right",color:d.colors.$color_black,size:"16px"}))};Tr.propTypes={backgroundColor:l.a.string,hoverColor:l.a.string,textColor:l.a.string,children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node])};const qr=c.a.a`
	align-items: center;
	justify-content: center;
	vertical-align: middle;
	color: ${d.colors.$color_black};
...
`,Ir=c.a.button`
	...
	padding: 0;
	cursor: pointer;
`;class zr extends a.a.Component{constructor(e){super(e)}render(){return Object(r.createElement)(Pr.a,{isOpen:this.props.isOpen,onRequestClose:this.props.onClose,role:"dialog",contentLabel:this.props.modalAriaLabel,overlayClassName:"yoast-modal__overlay "+this.props.className,className:"yoast-modal__content "+this.props.className,appElement:this.props.appElement,bodyOpenClassName:"yoast-modal_is-open"},Object(r.createElement)("div",null,this.props.heading&&Object(r.createElement)(Br,{className:"yoast-modal__title"},this.props.heading),this.props.closeIconButton&&Object(r.createElement)(Ir,{type:"button",onClick:this.props.onClose,className:"yoast-modal__button-close-icon "+this.props.closeIconButtonClassName,"aria-label":this.props.closeIconButton},Object(r.createElement)(y,{icon:"times",color:d.colors.$color_grey_text}))),Object(r.createElement)("div",{className:"yoast-modal__inside"},this.props.children),this.props.closeButton&&Object(r.createElement)("div",{className:"yoast-modal__actions"},Object(r.createElement)("button",{type:"button",onClick:this.props.onClose,className:"yoast-modal__button-close "+this.props.closeButtonClassName},this.props.closeButton)))}}zr.propTypes={children:l.a.any,className:l.a.string,isOpen:l.a.bool,onClose:l.a.func.isRequired,modalAriaLabel:l.a.string.isRequired,appElement:l.a.object.isRequired,heading:l.a.string,closeIconButton:l.a.string,closeIconButtonClassName:l.a.string,closeButton:l.a.string,closeButtonClassName:l.a.string},zr.defaultProps={children:null,className:"",heading:"",closeIconButton:"",closeIconButtonClassName:"",closeButton:"",closeButtonClassName:"",isOpen:!1};var Mr=c()(zr)`
...
`,Lr=e=>Object(r.createElement)("svg",B()({},e,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 500 500"}),Object(r.createElement)("path",{d:"M80,0H420a80,80,0,0,1,80,80V500a0,0,0,0,1,0,0H80A80,80,0,0,1,0,420V80A80,80,0,0,1,80,0Z",fill:"#a4286a"}),Object(r.createElement)("path",{d:"M437.61,2,155.89,500H500V80A80,80,0,0,0,437.61,2Z",fill:"#6c2548"}),Object(r.createElement)("path",{d:"M74.4,337.3v34.9c21.6-.9,38.5-8,52.8-22.5s27.4-38,39.9-72.9l92.6-248H214.9L140.3, 236l-37-116.2h-41l54.4,139.8a57.54,57.54,0,0,1,0,41.8C111.2,315.6,101.3,332.3,74.4,337.3Z",fill:"#fff"}),Object(r.createElement)("circle",{cx:"368.33",cy:"124.68",r:"97.34",transform:"translate(19.72 296.97) rotate(-45)",fill:"#9fda4f"}),Object(r.createElement)("path",{d:"M416.2,39.93,320.46,209.44A97.34,97.34,0,1,0,416.2,39.93Z",fill:"#77b227"}),Object(r.createElement)("path",{d:"M294.78,254.75h0l-.15-.08-.13-.07h0a63.6,63.6,0,0,0-62.56,110.76h0l.07,0,.06,0h0a63.6,63.6,0,0,0,62.71-110.67Z",fill:"#fec228"}),Object(r.createElement)("path",{d:"M294.5,254.59,231.94,365.35A63.6,63.6,0,1,0,294.5,254.59Z",fill:"#f49a00"}),Object(r.createElement)("path",{d:"M222.31,450.07A38.16,38.16,0,0,0,203,416.83h0l0,0h0a38.18,38.18,0,1,0,19.41,33.27Z",fill:"#ff4e47"}),Object(r.createElement)("path",{d:"M202.9,416.8l-37.54,66.48A38.17,38.17,0,0,0,202.9,416.8Z",fill:"#ed261f"}));function Dr(e){return e.type&&"Tab"===e.type.tabsRole}function Ar(e){return e.type&&"TabPanel"===e.type.tabsRole}function Fr(e){return e.type&&"TabList"===e.type.tabsRole}function Ur(e,t,o){return t in e?Object.defineProperty(e,t,{value:o,enumerable:!0,configurable:!0,writable:!0}):e[t]=o,e}function Hr(e,t){return n.Children.map(e,(function(e){return null===e?null:function(e){return Dr(e)||Fr(e)||Ar(e)}(e)?t(e):e.props&&e.props.children&&"object"==typeof e.props.children?Object(n.cloneElement)(e,function(e){for(var t=1;t<arguments.length;t++){var o=null!=arguments[t]?arguments[t]:{},r=Object.keys(o);"function"==typeof Object.getOwnPropertySymbols&&(r=r.concat(Object.getOwnPropertySymbols(o).filter((function(e){return Object.getOwnPropertyDescriptor(o,e).enumerable})))),r.forEach((function(t){Ur(e,t,o[t])}))}return e}({},e.props,{children:Hr(e.props.children,t)})):e}))}function Wr(e,t){return n.Children.forEach(e,(function(e){null!==e&&(Dr(e)||Ar(e)?t(e):e.props&&e.props.children&&"object"==typeof e.props.children&&(Fr(e)&&t(e),Wr(e.props.children,t)))}))}var Vr,Kr=o(30),Gr=o.n(Kr),Yr=0;function Zr(){return"react-tabs-"+Yr++}function Xr(e){var t=0;return Wr(e,(function(e){Dr(e)&&t++})),t}function Jr(){return(Jr=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e}).apply(this,arguments)}function Qr(e){return e&&"getAttribute"in e}function en(e){return Qr(e)&&"tab"===e.getAttribute("role")}function tn(e){return Qr(e)&&"true"===e.getAttribute("aria-disabled")}try{Vr=!("undefined"==typeof window||!window.document||!window.document.activeElement)}catch(e){Vr=!1}var on=function(e){var t,o;function r(){for(var t,o=arguments.length,r=new Array(o),n=0;n<o;n++)r[n]=arguments[n];return(t=e.call.apply(e,[this].concat(r))||this).tabNodes=[],t.handleKeyDown=function(e){if(t.isTabFromContainer(e.target)){var o=t.props.selectedIndex,r=!1,n=!1;32!==e.keyCode&&13!==e.keyCode||(r=!0,n=!1,t.handleClick(e)),37===e.keyCode||38===e.keyCode?(o=t.getPrevTab(o),r=!0,n=!0):39===e.keyCode||40===e.keyCode?(o=t.getNextTab(o),r=!0,n=!0):35===e.keyCode?(o=t.getLastTab(),r=!0,n=!0):36===e.keyCode&&(o=t.getFirstTab(),r=!0,n=!0),r&&e.preventDefault(),n&&t.setSelected(o,e)}},t.handleClick=function(e){var o=e.target;do{if(t.isTabFromContainer(o)){if(tn(o))return;var r=[].slice.call(o.parentNode.children).filter(en).indexOf(o);return void t.setSelected(r,e)}}while(null!=(o=o.parentNode))},t}o=e,(t=r).prototype=Object.create(o.prototype),t.prototype.constructor=t,t.__proto__=o;var s=r.prototype;return s.setSelected=function(e,t){if(!(e<0||e>=this.getTabsCount())){var o=this.props;(0,o.onSelect)(e,o.selectedIndex,t)}},s.getNextTab=function(e){for(var t=this.getTabsCount(),o=e+1;o<t;o++)if(!tn(this.getTab(o)))return o;for(var r=0;r<e;r++)if(!tn(this.getTab(r)))return r;return e},s.getPrevTab=function(e){for(var t=e;t--;)if(!tn(this.getTab(t)))return t;for(t=this.getTabsCount();t-- >e;)if(!tn(this.getTab(t)))return t;return e},s.getFirstTab=function(){for(var e=this.getTabsCount(),t=0;t<e;t++)if(!tn(this.getTab(t)))return t;return null},s.getLastTab=function(){for(var e=this.getTabsCount();e--;)if(!tn(this.getTab(e)))return e;return null},s.getTabsCount=function(){return Xr(this.props.children)},s.getPanelsCount=function(){return e=this.props.children,t=0,Wr(e,(function(e){Ar(e)&&t++})),t;var e,t},s.getTab=function(e){return this.tabNodes["tabs-"+e]},s.getChildren=function(){var e=this,t=0,o=this.props,r=o.children,s=o.disabledTabClassName,l=o.focus,i=o.forceRenderTabPanel,c=o.selectedIndex,d=o.selectedTabClassName,u=o.selectedTabPanelClassName;this.tabIds=this.tabIds||[],this.panelIds=this.panelIds||[];for(var p=this.tabIds.length-this.getTabsCount();p++<0;)this.tabIds.push(Zr()),this.panelIds.push(Zr());return Hr(r,(function(o){var r=o;if(Fr(o)){var p=0,h=!1;Vr&&(h=a.a.Children.toArray(o.props.children).filter(Dr).some((function(t,o){return document.activeElement===e.getTab(o)}))),r=Object(n.cloneElement)(o,{children:Hr(o.props.children,(function(t){var o="tabs-"+p,r=c===p,a={tabRef:function(t){e.tabNodes[o]=t},id:e.tabIds[p],panelId:e.panelIds[p],selected:r,focus:r&&(l||h)};return d&&(a.selectedClassName=d),s&&(a.disabledClassName=s),p++,Object(n.cloneElement)(t,a)}))})}else if(Ar(o)){var f={id:e.panelIds[t],tabId:e.tabIds[t],selected:c===t};i&&(f.forceRender=i),u&&(f.selectedClassName=u),t++,r=Object(n.cloneElement)(o,f)}return r}))},s.isTabFromContainer=function(e){if(!en(e))return!1;var t=e.parentElement;do{if(t===this.node)return!0;if(t.getAttribute("data-tabs"))break;t=t.parentElement}while(t);return!1},s.render=function(){var e=this,t=this.props,o=(t.children,t.className),r=(t.disabledTabClassName,t.domRef),n=(t.focus,t.forceRenderTabPanel,t.onSelect,t.selectedIndex,t.selectedTabClassName,t.selectedTabPanelClassName,function(e,t){if(null==e)return{};var o,r,n={},a=Object.keys(e);for(r=0;r<a.length;r++)o=a[r],t.indexOf(o)>=0||(n[o]=e[o]);return n}(t,["children","className","disabledTabClassName","domRef","focus","forceRenderTabPanel","onSelect","selectedIndex","selectedTabClassName","selectedTabPanelClassName"]));return a.a.createElement("div",Jr({},n,{className:Gr()(o),onClick:this.handleClick,onKeyDown:this.handleKeyDown,ref:function(t){e.node=t,r&&r(t)},"data-tabs":!0}),this.getChildren())},r}(n.Component);on.defaultProps={className:"react-tabs",focus:!1},on.propTypes={};var rn=function(e){var t,o;function r(t){var o;return(o=e.call(this,t)||this).handleSelected=function(e,t,n){var a=o.props.onSelect;if("function"!=typeof a||!1!==a(e,t,n)){var s={focus:"keydown"===n.type};r.inUncontrolledMode(o.props)&&(s.selectedIndex=e),o.setState(s)}},o.state=r.copyPropsToState(o.props,{},t.defaultFocus),o}o=e,(t=r).prototype=Object.create(o.prototype),t.prototype.constructor=t,t.__proto__=o;var n=r.prototype;return n.componentWillReceiveProps=function(e){this.setState((function(t){return r.copyPropsToState(e,t)}))},r.inUncontrolledMode=function(e){return null===e.selectedIndex},r.copyPropsToState=function(e,t,o){void 0===o&&(o=!1);var n={focus:o};if(r.inUncontrolledMode(e)){var a,s=Xr(e.children)-1;a=null!=t.selectedIndex?Math.min(t.selectedIndex,s):e.defaultIndex||0,n.selectedIndex=a}return n},n.render=function(){var e=this.props,t=e.children,o=(e.defaultIndex,e.defaultFocus,function(e,t){if(null==e)return{};var o,r,n={},a=Object.keys(e);for(r=0;r<a.length;r++)o=a[r],t.indexOf(o)>=0||(n[o]=e[o]);return n}(e,["children","defaultIndex","defaultFocus"])),r=this.state,n=r.focus,s=r.selectedIndex;return o.focus=n,o.onSelect=this.handleSelected,null!=s&&(o.selectedIndex=s),a.a.createElement(on,o,t)},r}(n.Component);function nn(){return(nn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e}).apply(this,arguments)}rn.defaultProps={defaultFocus:!1,forceRenderTabPanel:!1,selectedIndex:null,defaultIndex:null},rn.propTypes={},rn.tabsRole="Tabs";var an=function(e){var t,o;function r(){return e.apply(this,arguments)||this}return o=e,(t=r).prototype=Object.create(o.prototype),t.prototype.constructor=t,t.__proto__=o,r.prototype.render=function(){var e=this.props,t=e.children,o=e.className,r=function(e,t){if(null==e)return{};var o,r,n={},a=Object.keys(e);for(r=0;r<a.length;r++)o=a[r],t.indexOf(o)>=0||(n[o]=e[o]);return n}(e,["children","className"]);return a.a.createElement("ul",nn({},r,{className:Gr()(o),role:"tablist"}),t)},r}(n.Component);function sn(){return(sn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e}).apply(this,arguments)}an.defaultProps={className:"react-tabs__tab-list"},an.propTypes={},an.tabsRole="TabList";var ln=function(e){var t,o;function r(){return e.apply(this,arguments)||this}o=e,(t=r).prototype=Object.create(o.prototype),t.prototype.constructor=t,t.__proto__=o;var n=r.prototype;return n.componentDidMount=function(){this.checkFocus()},n.componentDidUpdate=function(){this.checkFocus()},n.checkFocus=function(){var e=this.props,t=e.selected,o=e.focus;t&&o&&this.node.focus()},n.render=function(){var e,t=this,o=this.props,r=o.children,n=o.className,s=o.disabled,l=o.disabledClassName,i=(o.focus,o.id),c=o.panelId,d=o.selected,u=o.selectedClassName,p=o.tabIndex,h=o.tabRef,f=function(e,t){if(null==e)return{};var o,r,n={},a=Object.keys(e);for(r=0;r<a.length;r++)o=a[r],t.indexOf(o)>=0||(n[o]=e[o]);return n}(o,["children","className","disabled","disabledClassName","focus","id","panelId","selected","selectedClassName","tabIndex","tabRef"]);return a.a.createElement("li",sn({},f,{className:Gr()(n,(e={},e[u]=d,e[l]=s,e)),ref:function(e){t.node=e,h&&h(e)},role:"tab",id:i,"aria-selected":d?"true":"false","aria-disabled":s?"true":"false","aria-controls":c,tabIndex:p||(d?"0":null)}),r)},r}(n.Component);function cn(){return(cn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e}).apply(this,arguments)}ln.defaultProps={className:"react-tabs__tab",disabledClassName:"react-tabs__tab--disabled",focus:!1,id:null,panelId:null,selected:!1,selectedClassName:"react-tabs__tab--selected"},ln.propTypes={},ln.tabsRole="Tab";var dn=function(e){var t,o;function r(){return e.apply(this,arguments)||this}return o=e,(t=r).prototype=Object.create(o.prototype),t.prototype.constructor=t,t.__proto__=o,r.prototype.render=function(){var e,t=this.props,o=t.children,r=t.className,n=t.forceRender,s=t.id,l=t.selected,i=t.selectedClassName,c=t.tabId,d=function(e,t){if(null==e)return{};var o,r,n={},a=Object.keys(e);for(r=0;r<a.length;r++)o=a[r],t.indexOf(o)>=0||(n[o]=e[o]);return n}(t,["children","className","forceRender","id","selected","selectedClassName","tabId"]);return a.a.createElement("div",cn({},d,{className:Gr()(r,(e={},e[i]=l,e)),role:"tabpanel",id:s,"aria-labelledby":c}),n||l?o:null)},r}(n.Component);dn.defaultProps={className:"react-tabs__tab-panel",forceRender:!1,selectedClassName:"react-tabs__tab-panel--selected"},dn.propTypes={},dn.tabsRole="TabPanel";const un=c.a.div`
	font-size: 1em;
...
`;un.propTypes={tabsTextColor:l.a.string,tabsTextTransform:l.a.string,tabsFontSize:l.a.string,tabsFontWeight:l.a.string,tabsBaseWidth:l.a.string};class pn extends a.a.Component{getTabs(){return this.props.items.map(e=>Object(r.createElement)(ln,{key:e.id},e.label))}getTabPanels(){return this.props.items.map(e=>Object(r.createElement)(dn,{key:e.id,tabIndex:"0"},e.content))}render(){return Object(r.createElement)(un,{tabsTextColor:this.props.tabsTextColor,tabsTextTransform:this.props.tabsTextTransform,tabsFontSize:this.props.tabsFontSize,tabsFontWeight:this.props.tabsFontWeight,tabsBaseWidth:this.props.tabsBaseWidth},Object(r.createElement)(rn,{onSelect:this.props.onTabSelect},Object(r.createElement)(an,null,this.getTabs()),this.getTabPanels()))}componentDidMount(){this.props.onTabsMounted()}}pn.propTypes={items:l.a.arrayOf(l.a.shape({id:l.a.string.isRequired,label:l.a.string.isRequired,content:l.a.object.isRequired})),tabsTextColor:l.a.string,tabsTextTransform:l.a.string,tabsFontSize:l.a.string,tabsFontWeight:l.a.string,tabsBaseWidth:l.a.string,onTabSelect:l.a.func,onTabsMounted:l.a.func},pn.defaultProps={items:[],tabsTextColor:d.colors.$color_grey_dark,tabsTextTransform:"none",tabsFontSize:"1.5em",tabsFontWeight:"200",tabsBaseWidth:"200px",onTabSelect:()=>{},onTabsMounted:()=>{}};var hn=pn,fn=o(76),bn=o.n(fn);const mn=c.a.div`
	display: flex;
	padding: 16px;
...
`;class vn extends a.a.Component{render(){const{message:e}=this.props;return bn()(e)?null:Object(r.createElement)(mn,null,Object(r.createElement)(gn,{icon:"exclamation-triangle",size:"16px"}),Object(r.createElement)(yn,null,e))}}vn.propTypes={message:l.a.array},vn.defaultProps={message:[]};var xn=vn;const On=c.a.div`
	position: relative;
...
`;function Cn(e){return Object(r.createElement)(On,null,Object(r.createElement)(lo,e))}Cn.propTypes={width:l.a.number,height:l.a.number,src:l.a.string.isRequired,title:l.a.string.isRequired,frameBorder:l.a.number,allowFullScreen:l.a.bool},Cn.defaultProps={width:560,height:315,frameBorder:0,allowFullScreen:!0};const wn=e=>{console.warn("The WordList component has been deprecated and will be removed in a future release.");const{title:t,classNamePrefix:o,words:n,header:a,footer:s}=e,l=Object(r.createElement)("ol",{className:o+"__list"},n.map(e=>Object(r.createElement)("li",{key:e,className:o+"__item"},e)));return Object(r.createElement)("div",{className:o},Object(r.createElement)("p",null,Object(r.createElement)("strong",null,t)),a,l,s)};wn.propTypes={words:l.a.array.isRequired,title:l.a.string.isRequired,header:l.a.string,footer:l.a.string,classNamePrefix:l.a.string},wn.defaultProps={classNamePrefix:"",header:"",footer:""};var jn=wn;const En=c.a.ul`
	margin: 0;
 	padding: 0;
 	list-style: none;
 	position: relative;
...
`;En.propTypes={children:l.a.any};class kn extends a.a.Component{constructor(e){super(e)}getChildren(){return 1===this.props.children?[this.props.children]:this.props.children}render(){const e=this.getChildren();return Object(r.createElement)(En,{role:"list"},e)}}class Sn extends kn{constructor(e){super(e),this.zebraProps=Object.assign({},e)}zebrafyChildren(){let e=this.props.children;this.props.children.map||(e=[e]),this.zebraProps.children=e.map((e,t)=>a.a.cloneElement(e,{background:t%2==1?d.colors.$color_white:d.colors.$color_background_light,key:t}))}render(){return this.zebrafyChildren(),Object(r.createElement)(En,B()({role:"list"},this.zebraProps))}}kn.propTypes={children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node])};const Tn=c.a.li`
	background: ${e=>e.background};
	display: flex;
	min-height: ${e=>e.rowHeight};
	align-items: center;
	justify-content: space-between;
`;Tn.propTypes={background:l.a.string,hasHeaderLabels:l.a.bool,rowHeight:l.a.string},Tn.defaultProps={background:d.colors.$color_white,hasHeaderLabels:!0},c()(Tn)`
